    ...
    <section ref={ref} id="home" className="mb-28 max-w-[75rem] text-center sm:mb-0">
      ...
      <Fade direction="up" delay={400} cascade damping={1e-1} triggerOnce={true}>
        <h1 className="mb-10 mt-4 px-4 text-2xl sm:text-4xl">
          <span className="font-medium !leading-[1.5] ">Hello, I'm Dwiki Arlian Maulana</span> <p className="text-[14px]">My journey in the realm of technology has been marked by diverse experience in IT Support.</p>
        </h1>
      </Fade>
